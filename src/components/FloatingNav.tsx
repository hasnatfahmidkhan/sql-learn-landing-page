...
import { Database, BookOpen, Filter, ArrowUpDown, Terminal, Zap, Menu, X, Dumbbell } from 'lucide-react';
            ...
            {navItems.map((item) => (
              ...
              >
                {activeSection === item.id && (
                  <motion.div
                    layoutId="activeNav"
                    className="absolute inset-0 rounded-xl bg-gradient-to-r from-cyan-500/20 to-emerald-500/20 border border-cyan-500/30"
